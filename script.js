...
(function($){
	...
	if ($count_token.length > 0 ) {
		$count_token.each(function() {
			...
			$self.countdown(datetime).on('update.countdown', function(event) {
				$(this).html(event.strftime('<div class="col"><span class="countdown-time">%d</span><span class="countdown-text">Días</span></div>' + '<div class="col"><span class="countdown-time">%H</span><span class="countdown-text">Horas</span></div>' + '<div class="col"><span class="countdown-time">%M</span><span class="countdown-text">Minutos</span></div>' + '<div class="col"><span class="countdown-time countdown-time-last">%S</span><span class="countdown-text">Segundos</span></div>'));
			});
		});
	...
	function prepareOnScrollAnimation() {
		// On Scroll Animation
		var $aniKey = $('.animated');
